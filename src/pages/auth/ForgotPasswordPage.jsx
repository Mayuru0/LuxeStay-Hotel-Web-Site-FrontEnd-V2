...
const ForgotPasswordPage = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      await api.post('/api/users/reset-password', { email, otp: Number(otp), newPassword });
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-800"
                />
                <button
                  type="button"
